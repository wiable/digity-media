...
var domainYes = document.getElementById("domain-yes");
var noServer = document.getElementById("server-no");
var yesServer = document.getElementById("server-yes");
var noEmployee = document.getElementById("no-employee");
var yesEmployee = document.getElementById("have-employee");
var needPlan = document.getElementById("need-plan");
var noneedPlan = document.getElementById("have-budget");
var nowebsiteOnAll = document.getElementById("website-on-all-no");
var yeswebsiteOnAll = document.getElementById("website-on-all-yes");
var nowebsiteAppearsAll = document.getElementById("website-appears-all-no");
var yeswebsiteAppearsAll = document.getElementById("website-appears-all-yes");
var nowebsiteOnEsign = document.getElementById("website-on-e-sign-no");
var yeswebsiteOnEsign = document.getElementById("website-on-e-sign-yes");
var yesneedSeo = document.getElementById("need-seo-yes");
var noneedSeo = document.getElementById("need-seo-no");
var yesneedLinkExchange = document.getElementById("link-exchange-need-yes");
var noneedLinkExchange = document.getElementById("link-exchange-need-yes");
...
threePageSiteCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

fivePageSiteCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

tenPageSiteCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

twentyPageSiteCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

oneAdditionalPageCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

threeAdditionalPageCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

fiveAdditionalPageCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

aboutUsPresentationPageCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

teamPresentationPageCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

companyHistoryPresentationPageCheckbox.addEventListener("change", function () {
  updateTotalAmount();
});

additionalAboutUsPage.addEventListener("change", function () {
  updateTotalAmount();
});

additionalCompanyNewsPage.addEventListener("change", function () {
  updateTotalAmount();
});

additionalPressPage.addEventListener("change", function () {
  updateTotalAmount();
});

additionalDirectSalePage.addEventListener("change", function () {
  updateTotalAmount();
});

additionalAdsSpecialPage.addEventListener("change", function () {
  updateTotalAmount();
});

additionalfedOptPage.addEventListener("change", function () {
  updateTotalAmount();
});

additionalCreationNewsletter.addEventListener("change", function () {
  updateTotalAmount();
});

additionalDiscussionForum.addEventListener("change", function () {
  updateTotalAmount();
});

additionalOneOnlineGame.addEventListener("change", function () {
  updateTotalAmount();
});

additionalChatFunction.addEventListener("change", function () {
  updateTotalAmount();
});

additionalInteractionWeb2.addEventListener("change", function () {
  updateTotalAmount();
});

additionalOfferFacebook.addEventListener("change", function () {
  updateTotalAmount();
});

additionalFAQ.addEventListener("change", function () {
  updateTotalAmount();
});

additionalCaseStudies.addEventListener("change", function () {
  updateTotalAmount();
});

additionalTutorials.addEventListener("change", function () {
  updateTotalAmount();
});

additionalDownloadsPage.addEventListener("change", function () {
  updateTotalAmount();
});

noDesignSystem.addEventListener("click", function () {
  updateTotalAmount();
});

yesDesignSystem.addEventListener("click", function () {
  updateTotalAmount();
});

noTextImages.addEventListener("click", function () {
  updateTotalAmount();
});
...
noDigitizedImages.addEventListener("click", function () {
  updateTotalAmount();
});

yesDigitizedImages.addEventListener("click", function () {
  updateTotalAmount();
});

domainNo.addEventListener("click", function () {
  updateTotalAmount();
});

domainYes.addEventListener("click", function () {
  updateTotalAmount();
});

noServer.addEventListener("click", function () {
  updateTotalAmount();
});

yesServer.addEventListener("click", function () {
  updateTotalAmount();
});

noEmployee.addEventListener("click", function () {
  updateTotalAmount();
});

yesEmployee.addEventListener("click", function () {
  updateTotalAmount();
});

needPlan.addEventListener("click", function () {
  updateTotalAmount();
});

noneedPlan.addEventListener("click", function () {
  updateTotalAmount();
});

nowebsiteOnAll.addEventListener("click", function () {
  updateTotalAmount();
});

yeswebsiteOnAll.addEventListener("click", function () {
  updateTotalAmount();
});

nowebsiteAppearsAll.addEventListener("click", function () {
  updateTotalAmount();
});

yeswebsiteAppearsAll.addEventListener("click", function () {
  updateTotalAmount();
});

nowebsiteOnEsign.addEventListener("click", function () {
  updateTotalAmount();
});

yeswebsiteOnEsign.addEventListener("click", function () {
  updateTotalAmount();
});

noneedSeo.addEventListener("click", function () {
  updateTotalAmount();
});

yesneedSeo.addEventListener("click", function () {
  updateTotalAmount();
});

yesneedLinkExchange.addEventListener("click", function () {
  updateTotalAmount();
});
...
function updateTotalAmount() {
  ...
  if (yesServer.checked) {
    amount += 0;
  }

  if (noEmployee.checked) {
    amount += 1000;
  }

  if (yesEmployee.checked) {
    amount += 0;
  }
  ...
  if (noneedPlan.checked) {
    amount += 0;
  }

  if (nowebsiteOnAll.checked) {
    amount += 800;
  }

  if (yeswebsiteOnAll.checked) {
    amount += 0;
  }

  if (nowebsiteAppearsAll.checked) {
    amount += 1200;
  }

  if (yeswebsiteAppearsAll.checked) {
    amount += 0;
  }

  if (nowebsiteOnEsign.checked) {
    amount += 100;
  }

  if (yeswebsiteOnEsign.checked) {
    amount += 0;
  }
